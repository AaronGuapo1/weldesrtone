        ...
        
		{
			...
			table: {
				...
				body: [
					...
					[{fontSize:9,text:productosMaterialesDescripcion}, {fontSize:11,text:productosMaterialesCodigo},{fontSize:11,text:ProductosMaterialesUnidad},{fontSize:11,text:PreciosMateriales}, {fontSize:11,text:productosMaterialesCantidad}, {fontSize:11,text:ImporteMateriales}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Material"},{fontSize:11,text: "Suma"}, {fontSize:11,text:MaterialSuma}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Mano de obra"}, {fontSize:11,text:ManoObMaterial+"%"}, {fontSize:11,text:ManoObMaterial1R}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Porcentaje"}, {fontSize:11,text:PorcentajeMaterial+"%"}, {fontSize:11,text:ManoObMaterial2R}],
                    [{fontSize:9,text:" "}, " "," ","",{fontSize:11,text:"Total"},{fontSize:11,text:Total1R} ],

					[{fontSize:9,text:productosPinturaDescripcion}, {fontSize:11,text:productosPinturaCodigo}, {fontSize:11,text:ProductosPinturasUnidad},{fontSize:11,text:PreciosPintura},{fontSize:11,text:productosPinturaCantidad},{fontSize:11,text:ImportePinturas}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Pintura"}, {fontSize:11,text:"Suma"}, {fontSize:11,text:PinturaSumaRedondeada}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Mano de obra"}, {fontSize:11,text:ManoObPintura+"%"},{fontSize:11,text:ManoObPintura1R}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Porcentaje"}, {fontSize:11,text:PorcentajePintura+"%"}, {fontSize:11,text:ManoObPintura2R}],
                    [{fontSize:9,text:" "}, " "," ","", {fontSize:11,text:"Total"},{fontSize:11,text:Total2R} ],

					[{fontSize:9,text:productosInstalacionDescripcion}, {fontSize:11,text:productosInstalacionCodigo},{fontSize:11,text:ProductosInstalacionUnidad},{fontSize:11,text:PreciosInstalaciones}, {fontSize:11,text:productosInstalacionCantidad}, {fontSize:11,text:ImporteInstalaciones}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Instalación"}, {fontSize:11,text:"Suma"}, {fontSize:11,text:InstalacionSuma}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Mano de obra"}, {fontSize:11,text:ManoObInstalacion+"%"},{fontSize:11,text:ManoObInstalacion1R}],
                    [{fontSize:9,text:" "}, " "," ",{fontSize:11,text:"Porcentaje"}, {fontSize:11,text:PorcentajeInstalacion+"%"},{fontSize:11,text:ManoObInstalacion2R}],
                    [{fontSize:9,text:" "}, " "," ","", {fontSize:11,text:"Total"},{fontSize:11,text:Total3R} ],
                    [{fontSize:9,text:" "}, " "," ","", {fontSize:11,text:"Subtotal"},{fontSize:11,text:SubTotalR} ],
                    [{fontSize:9,text:" "}, " "," ","", {fontSize:11,text:"Iva"},{fontSize:11,text:iva}],
                    [{fontSize:9,text:" "}, " "," ","", {fontSize:11,text:"Total"},{fontSize:11,text:TotalFinal} ],
